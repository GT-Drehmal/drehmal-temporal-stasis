...
playsound minecraft:dcustom.entity.zombie_villager.converted master @s ~ ~ ~ 99999999999999 1 1
...
execute if score yavhlix towers matches 0 run function terminus:unlock_tower/yavhlix_unlock
