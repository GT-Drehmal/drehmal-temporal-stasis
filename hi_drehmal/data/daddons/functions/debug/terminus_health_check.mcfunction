...
scoreboard players set have_notified debug 0

execute unless score capital_valley towers matches 1 run say [!] Capital Valley tower is supposed to be unlocked but is not [!]
execute unless score capital_valley towers matches 1 run scoreboard players set have_notified debug 1

execute unless score av_sal towers matches 1 run say [!] Av'Sal tower is supposed to be unlocked but is not [!]
execute unless score av_sal towers matches 1 run scoreboard players set have_notified debug 1

execute unless score palisades_heath towers matches 1 run say [!] Palisades tower is supposed to be unlocked but is not [!]
execute unless score palisades_heath towers matches 1 run scoreboard players set have_notified debug 1
...
execute unless score gulf_of_drehmal towers matches 1 run scoreboard players set have_notified debug 1

execute unless score north_tharxax towers matches 1 run say [!] North Thrarxax tower is supposed to be unlocked but is not [!]
execute unless score north_tharxax towers matches 1 run scoreboard players set have_notified debug 1
...
execute if score tower_total debug = count_all towers if score have_notified debug matches 0 run say [Terminus Health Check] All checks passed.