...
# You've out of'ed your last bounds
# Default spawn
execute if score @s oob_warning matches 60.. run spawnpoint @s 778 106 688
execute if score @s oob_warning matches 60.. run effect clear @s
