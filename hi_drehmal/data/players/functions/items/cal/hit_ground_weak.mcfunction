...
playsound minecraft:dcustom.entity.generic.small_fall player @s ~ ~ ~ 10 1
playsound minecraft:dcustom.entity.generic.explode player @s ~ ~ ~ 2 2
playsound minecraft:dcustom.entity.player.attack.weak player @s ~ ~ ~ 10 1
playsound minecraft:dcustom.entity.wolf.growl player @s ~ ~ ~ 10 0.5
playsound minecraft:dcustom.entity.zombified_piglin.death player @s ~ ~ ~ 10 0.5
tag @s add cal_temp
