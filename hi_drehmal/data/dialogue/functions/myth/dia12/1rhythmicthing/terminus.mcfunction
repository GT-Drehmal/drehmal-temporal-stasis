...
execute if score #rhythmicthing timer matches 20 run tellraw @a[tag=in_terminus] [{"text":"["},{"text":"ａｖＳＹＳ","color":"gold"},{"text":"] ／／ＷＡＲＮＩＮＧ： ＲＥＯＣＣＵＲＲＩＮＧ ＥＲＲＯＲ ＩＮ ＳＹＳＴＥＭ ＣＯＮＦＩＧ ＤＥＴＥＣＴＥＤ／／"}]
...
execute if score #rhythmicthing timer matches 300 run playsound minecraft:dcustom.block.beacon.ambient block @a 26475 139 -54 100 2
