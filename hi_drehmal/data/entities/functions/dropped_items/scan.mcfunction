...
# Modified to disable lodahr portals before 75%
execute if score #lodahr_beento bool matches 1 if predicate entities:netheritescrap store success score #load_this temp run tag @s add celestial_scrap
