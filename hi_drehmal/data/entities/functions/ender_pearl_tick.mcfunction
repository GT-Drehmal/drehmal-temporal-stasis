...
execute if score count_all towers matches 8.. if entity @s[predicate=players:overworld,x=2416.5,y=144.0,z=1177.5,dx=2,dy=3,dz=2] run function entities:misc/epearl_tp_player
