...
execute if score @s buff_ani matches 52 align xyz run playsound minecraft:dcustom.block.beacon.deactivate block @a[dx=1,dy=2,dz=1] ~ ~ ~ 1 0.8
...
execute if score @s buff_ani matches 30 align xyz run playsound minecraft:dcustom.block.fire.extinguish block @a[dx=1,dy=2,dz=1]
execute if score @s buff_ani matches 30 align xyz run playsound minecraft:dcustom.entity.iron_golem.repair block @a[dx=1,dy=2,dz=1]
...
execute if score @s buff_ani matches 10 unless score @s rdoor_old matches 1 run playsound minecraft:dcustom.block.piston.contract block @a
