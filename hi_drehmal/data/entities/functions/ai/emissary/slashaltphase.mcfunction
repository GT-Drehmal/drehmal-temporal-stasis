...
execute if score @s ai_ani matches 5 run function emis:animations/alts/play
execute if score @s ai_ani matches 5 run data merge entity @s {NoAI:1b}
execute if score @s ai_ani matches 5..15 positioned ^ ^ ^5 facing entity @p feet positioned ^ ^ ^0.2 facing entity @s feet facing ^ ^ ^-1 positioned as @s rotated ~ 0 run teleport @s ~ ~ ~ ~ ~
...
execute if score @s ai_ani matches 28..33 run scoreboard players set #swee.reverse temp 1
execute if score @s ai_ani matches 28..33 positioned ^0.15 ^1.5 ^1.25 facing ^2.35 ^0.5 ^-1.85 run function entities:ai/emissary/sweep/main
