...
execute if score #lodahr_beento bool matches 1 if entity @s[tag=celestial_scrap] if score #5T timer matches 3 run function core:scene/lodahr_portals/main_item
