...
execute if score #temp_dev bool matches 1 run tellraw @s {"text":"ＤＥＶＥＬＯＰＥＲ ＭＯＤＥ ＤＩＳＡＢＬＥＤ","color":"red"}


execute if score #temp_dev bool matches 0 run scoreboard players set @s isDev 1
execute if score #temp_dev bool matches 0 run tellraw @s {"text":"ＤＥＶＥＬＯＰＥＲ ＭＯＤＥ ＥＮＡＢＬＥＤ","color":"green"}