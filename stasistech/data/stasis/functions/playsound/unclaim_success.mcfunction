playsound minecraft:item.trident.thunder master @s ~ ~ ~ 0.15 0.5
playsound minecraft:block.amethyst_cluster.step master @s ~ ~ ~ 1 0.5
playsound minecraft:block.chain.break master @s ~ ~ ~ 0.06 0.5
