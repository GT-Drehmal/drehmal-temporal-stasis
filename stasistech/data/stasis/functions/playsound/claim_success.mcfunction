...
playsound minecraft:item.bone_meal.use master @a ~ ~ ~ 1 0.5
playsound minecraft:block.respawn_anchor.charge master @a ~ ~ ~ 1 0.25
playsound minecraft:block.shroomlight.place master @a ~ ~ ~ 1 1
playsound minecraft:block.copper.step master @a ~ ~ ~ 1 1
