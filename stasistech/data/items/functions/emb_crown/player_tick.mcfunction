...
execute unless score @s embc_deaths matches 1.. unless predicate players:adventure_areas unless predicate items:player/has_fire_res at @s run summon small_fireball ~ ~2.1 ~ {Silent:1b,HasVisualFire:0b,power:[0.0,-2.2,0.0],Tags:["embc_fire"],Item:{id:"minecraft:air",Count:1}}
